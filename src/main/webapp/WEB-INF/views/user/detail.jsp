    ...
    <main>
        ...
        <section class="breadcrumb">
            <ul class="breadcrumb__list d-flex container">
                ...
                <li><span class="breadcrumb__link">></span></li>
                <li><span class="breadcrumb__link active">Sản phẩm chi tiết</span></li>
            </ul>
        </section>
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="../images/product-img/vl1.jpg"
                                                    alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="../images/product-img/vl2.jpg"
                                                    alt="Product Image 2">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="../images/product-img/vl3.jpg"
                                                    alt="Product Image 3">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="../images/product-img/vl5.jpg"
                                                    alt="Product Image 4">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="../images/product-img/vl6.jpg"
                                                    alt="Product Image 4">
                                            </a>
                                        </div>
                                    </div>
