            ...
            <div class="container d-grid">
                ...
                <ul class="nav-menu">
                    <li class="active-link">
                        <a href="/user/index" title="Trang chủ">Trang chủ</a>
                    </li>
                    <li>
                        <a href="/user/shop" title="Mua sắm <.">Mua sắm <i class="bi bi-chevron-down"></i></a>
                        <div class="my-dropdown-menu">
                            <div class="container d-flex" style="grid-gap: 40px;">
                                <div class="right-section d-grid gap-2" style="grid-template-columns: repeat(5, 1fr);">
                    ...
                    <li>
                        <a href="/user/product" title="Sản phẩm <.">Sản phẩm <i class="bi bi-chevron-down"></i></a>
                        <div class="my-dropdown-menu">
                    ...
                    <li>
                        <a href="/user/news" title="Tin tức">Tin tức</a>
                    </li>
                    <li>
                        <a href="/user/contactus" title="Liên hệ">Liên hệ</a>
                    </li>
                </ul>
