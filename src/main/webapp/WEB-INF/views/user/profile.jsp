...
.profile-image img, .profile-link img {
	height: 100%;
	width: 100%;
	...
	<main>
		...
		<section class="breadcrumb">
			<ul class="breadcrumb__list d-flex container">
				...
				<c:if test="${url == 'history'}">
					<li><span class="breadcrumb__link">></span></li>
					<li><span class="breadcrumb__link active">Lịch sử mua
							hàng</span></li>
				</c:if>
			</ul>
		</section>
		...
		<div class="container mt-5">
			<div class="d-flex align-items-start">
				<ul class="nav flex-column nav-item me-3 col-md-3 gap-3"
					id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<div class="profile-container d-flex p-3 align-items-center"
					...
					<a class="btn btn-outline-dark " id="account-tab"
						href="/user/profile/account" data-bs-toggle="pill"
						data-bs-target="#account" role="tab" aria-controls="account-tab"
						aria-selected="true">Tài khoản</a>
					<a class="btn btn-outline-dark" id="profile-tab"
						href="/user/profile/profile" data-bs-toggle="pill"
						data-bs-target="#profile" role="tab" aria-controls="profile-tab"
						aria-selected="false">Hồ sơ</a>
					<a class="btn btn-outline-dark" id="favorite-tab"
						href="/user/profile/favorite" data-bs-toggle="pill"
						data-bs-target="#favorite" role="tab" aria-controls="favorite-tab"
						aria-selected="false">Yêu thích</a>
					<a class="btn btn-outline-dark" id="history-tab"
						href="/user/profile/history" data-bs-toggle="pill"
						data-bs-target="#history" role="tab" aria-controls="history-tab"
						aria-selected="false">Đơn mua</a>
				</ul>
				<div class="tab-content col-md-9 container" id="v-pills-tabContent">
					<div class="tab-pane fade row" id="account" role="tabpanel"
						...
						<div class="row">
							...
							<fr:form class="col-12 row pt-3" action="/user/profile/account"
								...
								<div class="col-md-8 p-3">
									<div class="row mb-3 align-items-center">
										...
										<div class="col-7">
											<c:if test="${not empty sessionScope.userLogin}">
												<input type="text" id="txtUsername" name="user_names"
													class="form-control" aria-labelledby="passwordHelpInline"
													value="${sessionScope.userLogin.getUser_names()}" readonly />
											</c:if>
										...
										<div class="col-7">
											<c:if test="${not empty sessionScope.userLogin}">
												<input type="email" id="txtEmail" name="email"
													class="form-control" aria-labelledby="passwordHelpInline"
													value="${sessionScope.userLogin.getEmail()}" readonly>
											</c:if>
									...
									<div class="row mb-3 align-items-center">
										...
										<div class="col-7">
											<c:if test="${not empty sessionScope.userLogin}">
												<input type="text" id="txtNumberPhone" name="phones"
													class="form-control" aria-labelledby="passwordHelpInline"
													value="${sessionScope.userLogin.getPhones()}" readonly>
											</c:if>
									...
									<div class="row mb-3 align-items-center">
										...
										<div class="col-7">
											<input type="password" id="txtPassword" name="txtPassword"
												class="form-control" value="${users.pass_words}"
												aria-labelledby="passwordHelpInline">
										</div>
									</div>
									<div class="row mb-3 align-items-center">
										<div class="col-4">
											<label for="" class="col-form-label">Xác nhận mật
												khẩu: </label>
										</div>
										<div class="col-7">
											<input type="password" id="txtConfirmPassword"
												name="txtConfirmPassword" value="${users.pass_words}"
												class="form-control" aria-labelledby="passwordHelpInline">
										</div>
									</div>
									...
									<div class="row justify-content-center">
										<fr:button type="submit"
											formaction="/user/profile/account/${sessionScope.userLogin.id}"
								...
								<!-- form  -->
								<div class="col-md-4 pt-3" action="/user/profile/account"
									method="POST" modelAttribute="users"
									enctype="multipart/form-data">
									<div class="col-10" style="margin: 25px; width: 90%">
										<div
											style="width: 100%; height: 200px; border: 1px dotted gray;">
											<c:if test="${empty users.images}">
												<img id="img" alt="Default Images"
													src="/images/profile-1.jpg" width="100%" height="100%"
													style="object-fit: contain;">
											</c:if>
											<c:if test="${!empty users.images}">
												<img id="img" alt="Default Images"
													src="/images/user-img/${users.images}" width="100%"
							...
							<div class="row">
								...
								<div class="col-12 pt-3">
									<div class="container text-center">
										<form class="row g-2" action="/user/profile/profile"
											method="POST" modelAttribute="users">
											<div class="col-6">
												<div class="row mb-3 align-items-center">
													<div class="col-4">
														<label for="txtFirstName" class="col-form-label">Họ:
														</label>
													</div>
													<div class="col-7">
														<input type="text" name="last_names"
															value="${users.last_names}" id="txtFirstName"
															class="form-control" aria-labelledby="passwordHelpInline">
													</div>
												</div>
											</div>
											<div class="col-6">
												<div class="row mb-3 align-items-center">
													<div class="col-4">
														<label for="txtLastName" class="col-form-label">Tên:
														</label>
													</div>
													<div class="col-7">
														<input type="text" name="first_names"
															value="${users.first_names}" id="txtLastName"
															class="form-control" aria-labelledby="passwordHelpInline">
													</div>
												</div>
											</div>
											...
											<div class="col-6">
												<div class="row mb-3 align-items-center">
													...
													<div class="col-7">
														<input type="text" name="phones" value="${users.phones}"
															id="txtNumberPhone" class="form-control"
															aria-labelledby="passwordHelpInline">
													</div>
												</div>
											</div>
												...
												<div class="row mb-3 align-items-center">
													...
													<div class="col-10">
														<textarea class="form-control" name="address"
															id="txtAddress" style="height: 100px;"
															placeholder="Vui lòng nhập địa chỉ ở đây" required>${users.address}</textarea>
													</div>
												</div>
											</div>
											<hr>
											...
											<div class="row justify-content-center">
												<button type="submit" class="btn btn-outline-dark col-4">
													Lưu thay đổi</button>
											</div>
										</form>
									</div>
									...
									<div class="col-md-3 col-sm-6">
										<div class="product-grid6">
											<div class="card rounded-0">
												...
												<ul class="social">
													<li><a href="#" data-tip="Xem lướt qua"
					...
					<div class="tab-pane fade " id="history" role="tabpanel"
						...
						<c:forEach var="item" items="${listOrder}">
							<div class="col-12 p-3"
								...
								<div class="header__order d-flex justify-content-between">
									<h5 class="d-flex align-items-center gap-2">
										Đơn hàng: <span class="new__price"> <c:if
												test="${item.id < 10}">
										#000${item.id}
									</c:if> <c:if test="${item.id < 100 && item.id >= 10}">
										#00${item.id}
									</c:if> <c:if test="${item.id < 1000 && item.id >= 100}">
										#0${item.id}
									</c:if>
										</span>
									</h5>
								...
								<c:forEach var="itemOD" items="${item.order_details}">
									<div class="body__order d-grid align-items-center py-3 mt-3"
										...
										<div class="body__order-image text-start">
											<img
												style="background-image: url(/images/product-img/${itemOD.products.images});">
											</img>
										</div>
										<div class="body__order-content">
											<span class="body__order-title fw-bold">${itemOD.products.titles}</span>
											<span class="body__order-quanity"> x
												${itemOD.quanlity} </span>
										</div>
										<div
											class="body__order-price d-flex justify-content-center align-items-center gap-2">
											<c:if
												test="${itemOD.products.discounts.price_discounts == 0}">
												<span class="new__price"> <fmt:formatNumber
														value="${itemOD.products.price}" pattern="###,###,### VNĐ" />
												</span>
											</c:if>
											<c:if
												test="${itemOD.products.discounts.price_discounts != 0}">
												<span class="new__price"> <fmt:formatNumber
														value="${itemOD.products.price - (itemOD.products.price * (itemOD.products.discounts.price_discounts/100))}"
														pattern="###,###,### VNĐ" />
												</span>
								...
								<div
									class="footer__order d-flex mt-3 p-3 justify-content-between"
									style="border-top: 1px solid #ccc; background-color: #eee;">
									<div class="footer__order-btns">
										<a href="#" class="btn btn-dark">Mua lại</a> <a href="#"
											class="btn btn-outline-warning" data-bs-toggle="modal"
											data-bs-target="#rateModal${item.id}">Đánh giá</a>
									</div>
									<div class="footer__order-total d-flex gap-2">
										<h5>Thành tiền:</h5>
										<span class="new__price"> <fmt:formatNumber
												value="${item.sum_money}" pattern="###,###,### VNĐ" />
										</span>
									</div>
								</div>
							</div>
							...
							<!-- Modal Rate Product -->
							<form action="/user/profile/account/star" method="POST" class="modal fade" id="rateModal${item.id}" tabindex="-1"
								aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">Đánh
												giá sản phẩm</h1>
										...
										<div class="modal-body">
											...
											<ul class="nav nav-tabs" id="myTab" role="tablist">
												<c:forEach var="itemOD" items="${item.order_details}">
													...
													<c:if test="${count == 1}">
														<button class="nav-link active" id="product-${itemOD.id}"
															data-bs-toggle="tab"
															data-bs-target="#product-${itemOD.id}-tab" type="button"
															role="tab" aria-controls="product-${itemOD.id}-tab"
															aria-selected="true">Sản phẩm ${count}</button>
													</c:if>
													
													<c:if test="${count != 1}">
														<button class="nav-link" id="product-${itemOD.id}"
															data-bs-toggle="tab"
															data-bs-target="#product-${itemOD.id}-tab" type="button"
															role="tab" aria-controls="product-${itemOD.id}-tab"
															aria-selected="true">Sản phẩm ${count}</button>
											...
											<div class="tab-content" id="myTabContent">
												...
												<c:forEach var="itemOD" items="${item.order_details}">
													<c:if test="${temp == 1}">
														...
														id="product-${itemOD.id}-tab" role="tabpanel"
														aria-labelledby="product-${itemOD.id}" tabindex="0">
													</c:if>
													<c:if test="${temp != 1}">
																...
																<div class="d-grid "
																	...
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="radio"
																			name="star${itemOD.id}" id="rdo1" value="1"> <label
																			class="form-check-label" for="rdo1">1</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="radio"
																			name="star${itemOD.id}" id="rdo2" value="2"> <label
																			class="form-check-label" for="rdo2">2</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="radio"
																			name="star${itemOD.id}" id="rdo3" value="3"> <label
																			class="form-check-label" for="rdo3">3</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="radio"
																			name="star${itemOD.id}" id="rdo4" value="4"> <label
																			class="form-check-label" for="rdo4">4</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="radio"
																			name="star${itemOD.id}" id="rdo5" value="5" checked> <label
																			class="form-check-label" for="rdo5">5</label>
																	</div>
																</div>
																<div class="my-3">
																	<label for="exampleFormControlTextarea1"
																		class="form-label">Đánh giá:</label>
																	<textarea class="form-control" id="content${itemOD.id}" name="content${itemOD.id}"
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary"
							...
							<%-- <c:if test="${users.product_reviews.is_active != 1}"> --%>
								<button type="submit" formaction="/user/profile/account/star/${item.id}" class="btn btn-primary">Đánh giá</button>
							<%-- </c:if> --%>
